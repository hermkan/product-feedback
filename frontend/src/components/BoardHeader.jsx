...
function BoardHeader() {
  return (
    <div className="theme-product-feedback bg-skin-fill-navy-300 text-skin-base w-w-board-header h-h-board-header rounded-10 gap-2 px-4 grid grid-cols-3 items-center">
      ...
      <div className="flex gap-2 items-center relative cursor-pointer">
        ...
        <div className="absolute top-16">{/* <BoardHeaderDropDown /> */}</div>
      </div>
      <AddFeedbackButton />
    </div>
  );
